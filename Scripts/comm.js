...
function boxs(v, content) {
    ...
    if (v == 1) {
        ...
        ht.style.height = '100%';
        boht.innerHTML = '<div id="bg"></div><div id="info"><div id="center"><strong>信息提示</strong><p>' + content + '<br><a href="#" onclick="refresh()"> <img src="/images/confirm.gif" border="0"> </a></p></div></div>';
    }
}
