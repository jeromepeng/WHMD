<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="WHMD.Login.AdminLogin" %>
    ...
    <table width="705" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="331" height="33">
                            <input name="txtLoginName"  id="txtLoginName" type="text" style="font-size:14px" class="text" onblur="checkaccount()" />
                        </td>
                    </tr>
                    <tr>
                        <td width="301" height="33">
                        ...
                        <td height="33">
                            <input name="txtLoginPass" id="txtLoginPass" type="password" class="text"  onblur="checkpwd()" />
                        </td>
                    </tr>
                    <tr>
                        <td width="301" height="33">
        ...
        <tr>
            <td width="705" height="54" align="center" background="../Images/login03.png" style="color: #115287;">
                CopyRight <%=DateTime.Now.Year %> WHMD
            </td>
        </tr>
        <tr>
            <td>
