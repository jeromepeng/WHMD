...
namespace WHMD.Manager
{
    public partial class WebSiteType : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string template = "<tr><td height=\"20\" bgcolor=\"#FFFFFF\"><div align=\"center\">{0}</div></td><td height=\"20\" bgcolor=\"#FFFFFF\"><div align=\"center\">{1}</div></td><td height=\"20\" bgcolor=\"#FFFFFF\"><div align=\"center\"><a href=\"#\" onclick=\"editwtname({2},'{3}')\" style=\"color:blue;cursor:pointer;\">编辑</a> | <a href=\"javascript:delwebsitetype('{4}')\" style=\"color:blue;cursor:pointer;\">删除</a></div></td></tr>";
