...
namespace WHMD.Helper
{
    public partial class Validator : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            int vnum = Int32.Parse(Request.QueryString["vnum"].ToString());
            int rnum = Int32.Parse(Request.QueryString["rnum"].ToString());
            this.CreateCheckCodeImage(RndNum(vnum, rnum));
        }
        private string RndNum(int vnum, int rnum)
        {
            int number;
            char code;
